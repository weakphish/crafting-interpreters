...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> { // statements produce no value, hence 'void'
    ...
    public Object visitBinaryExpr(Expr.Binary expr) {
        ...
        switch (expr.operator.type()) {
            ...
            case MINUS:
                checkNumberOperands(expr.operator, left, right);
                return (double) left - (double) right;
            case PLUS: // special because it handles strings as well
     ...
     * @return the subexpression's evaluated result
     */
    @Override
    ...
    /**
     * Simply sends the expression back into the intepreter's visitor implementation
     *
     * @param expr The expression to evaluate
     * @return the evaluated result from the expr's accept implementation
     */
